						...
						elements={[
							{
								...
								content: (
									<span>
										Early prototypes need to be simple, modifiable, and impactful
										<br />
										<em>(even if they fall apart!)</em>.
										<br />
										<br />
										At Hard Stuff, we build the prototypes you need to demonstrate viablity, engage
										with customers, and unlock investment.
										<br />
										<br />
										<em>
											An MVP is only <span className="hardstuff-no-colour">minimum</span> when you
											can't have possibly made it cheaper or faster!
										</em>
									</span>
								),
							},
							{
								...
								content: (
									<span>
										The majority of the problems that humanity faces are outside, not at an office
										...
										<br />
										<em>
											An MVP is only <span className="hardstuff-no-colour">viable</span> when
											you've tested it in the field to prove that it solves the problem in
							...
							},
							{
								...
								content: (
									<span>
										We work with startups to ensure that they can build their hardware at the scale
										and price-point that unlocks meaningful potential.
										<br />
										<br />
										...
										<br />
										<em>
											An MVP is only a <span className="hardstuff-no-colour">product</span> when
