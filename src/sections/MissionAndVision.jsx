            ...
            <section className="section">
                <div className="content">
                    <p>
                        ...
                        entrepreneurs, providing them with the support, resources, and partnerships they need to bring
                        their groundbreaking ideas to life. Together, we'll shape a sustainable future for generations
                        to come.
                    </p>
                </div>
            </section>
            <section className="section">
                <div className="content">
                    <p>
                        ...
                        We know how far away from that world we are today, and how all this stuff, this really really
